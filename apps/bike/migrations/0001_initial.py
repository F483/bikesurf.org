...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bike'
        db.create_table('bike_bike', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bikes', to=orm['team.Team'])),
            ...
            ('station', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bikes', to=orm['station.Station'])),
            ('lockcode', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('size', self.gf('django.db.models.fields.CharField')(default='MEDIUM', max_length=64)),
            ('lights', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bikes_created', to=orm['account.Account'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bikes_updated', to=orm['account.Account'])),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('bike', ['Bike'])


    def backwards(self, orm):
        # Deleting model 'Bike'
        db.delete_table('bike_bike')
