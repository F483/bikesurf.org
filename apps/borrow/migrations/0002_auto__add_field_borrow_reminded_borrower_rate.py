...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Borrow.reminded_borrower_rate'
        db.add_column('borrow_borrow', 'reminded_borrower_rate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Borrow.reminded_borrower_rate'
        db.delete_column('borrow_borrow', 'reminded_borrower_rate')
