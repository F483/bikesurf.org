...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Borrow.reminded_borrower_pickup'
        db.add_column('borrow_borrow', 'reminded_borrower_pickup',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Borrow.reminded_borrower_dropoff'
        db.add_column('borrow_borrow', 'reminded_borrower_dropoff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Borrow.reminded_lender_putout'
        db.add_column('borrow_borrow', 'reminded_lender_putout',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Borrow.reminded_lender_takein'
        db.add_column('borrow_borrow', 'reminded_lender_takein',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Borrow.reminded_borrower_pickup'
        db.delete_column('borrow_borrow', 'reminded_borrower_pickup')

        # Deleting field 'Borrow.reminded_borrower_dropoff'
        db.delete_column('borrow_borrow', 'reminded_borrower_dropoff')

        # Deleting field 'Borrow.reminded_lender_putout'
        db.delete_column('borrow_borrow', 'reminded_lender_putout')

        # Deleting field 'Borrow.reminded_lender_takein'
        db.delete_column('borrow_borrow', 'reminded_lender_takein')
    ...
    models = {
        ...
        'borrow.borrow': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reminded_borrower_dropoff': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'reminded_borrower_pickup': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'reminded_borrower_rate': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'reminded_lender_putout': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'reminded_lender_takein': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
