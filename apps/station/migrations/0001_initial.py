...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('station_station', (
            ...
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stations', to=orm['team.Team'])),
            ('responsible', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Account'])),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('street', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('postalcode', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stations_created', to=orm['account.Account'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stations_updated', to=orm['account.Account'])),
